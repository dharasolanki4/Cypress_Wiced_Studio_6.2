...
//#if TOSHIBA
//#include "host_api.h" /* TODO: Toshiba-specific code here. Should be moved out of Tile Lib */
//#else
//#include "arch_wdg.h" /* TODO: Dialog-specific code here. Should be moved out of Tile Lib */
//#endif
...
int Tile_uECC_verify(const uint8_t public_key[uECC_BYTES*2],
    ...
    for (i = numBits - 2; i >= 0; --i) {
        ...
        // Allow Platform specific action be taken during ECC loop
        if((0 != tofu) && (0 != tofu->ecc_loop_cb))
        {
          tofu->ecc_loop_cb(numBits, i);
        }

//#if TOSHIBA
//        /* Call OS_API_Sleep, so link-layer has time to process any pending events */
//        /* TODO: Toshiba-specific code here. Should be moved out of Tile Lib */
//        OS_API_Sleep(1);
//#else
//        /* TODO: Dialog-specific code here. Should be moved out of Tile Lib */
//        /* reset the watchdog half way as the whole loop takes longer than the watchdog timer */
//        if(i == (numBits/2))
//        {
//          SetWord16(WATCHDOG_REG, WATCHDOG_DEFAULT_PERIOD);          // Reset WDOG! 200 * 10.24ms active time for normal mode!
//        }
//#endif
