...
struct song_hdr_info_t
{
  ...
  uint8_t  song_number;     ///< song_number describes what the Type of Song being Programmed and what song_number to use for playing the Song using @ref TOA_SONG_CMD_PLAY command.
  uint16_t song_id;         ///< song_id is the Tile Assigned ID Number of this Song. See @ref SONG_ID
