...
#define TDT_HDC_IBEACON_INTERVAL      40    ///< in tens of miliseconds
#define TDT_HDC_ADVERTISING_INTERVAL  160   ///< in tens of miliseconds
...
struct tile_tdt_module
{
   ...
   */
  uint8_t hdc_status;
  uint32_t hdc_iBeacon_interval;
  uint32_t hdc_adv_interval;
